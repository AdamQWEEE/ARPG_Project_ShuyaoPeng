...
private float acceleration=1f;
	...
	private string text1="YOUR FIRST TEXT";//<--change texts here:
	private string text2="YOUR SECOND TEXT";//<--
	private string text3="YOUR THIRD TEXT";//<--
	private string text4="YOUR FOURTH TEXT";//<--
	...
	void Start () {
		...
		second= this.transform.Find("text2").gameObject;
		texts[1]=text1;
		texts[1] =text2;
		texts[2] =text3;
		texts[3] =text4;
